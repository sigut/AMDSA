...
#        f.write('go')
    ...
    def cpptrajScript(self):
        ...
        if clusterAnalysis == "on":
            f.write("cluster dbscan kdist 4 rms @CA,C,N sieve 10 loadpairdist pairdist CpptrajParDist  \n")            
            ...
            f.write("cluster dbscan minpoints "+dbscan_minpoints+" epsilon "+epsilon_dbscan+" rms @CA,C,N sieve "+sieve_dbscan+" loadpairdist pairdist CpptrajPairDist out data/cluster_dbscan_out.txt summary data/cluster_dbscan_summary_out.txt repout data/cluster/dbscan_centroid repfmt pdb \n")
            f.write("go \n")
            f.write('\n')
        ...
        if PCA == "on":
            ...
            f.write('\n')
            f.write("analyze matrix matrixdat out data/pca/evecs-ca.dat vecs 10 \n")
