...
rotation        =   configSetup.get('Leap','rotation')
exterior        =   configSetup.get('Leap','exterior')
...
nstlim      = configSetup.get('in_files','nstlim')
...
sMDSteps       = configSetup.get('Steered','sMDSteps')
sMDEquilSteps  = configSetup.get('Steered','sMDEquilSteps')
